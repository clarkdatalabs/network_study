...
g = Graph.Read_GML('../graphs/4/pointfivefive.gml')
N = g.vcount()
Edges = g.get_edgelist()
layt = g.layout('kk')

g2 = Graph.Read_GML('../graphs/4/pointfiveseven.gml')
N2 = g2.vcount()
...
trace3=Scatter(x=Xe2,
               y=Ye2,
               mode='lines',
               line=Line(color='rgb(188,231,132)', width=0.8),
               hoverinfo='none'
               )
trace4=Scatter(x=Xn2,
               y=Yn2,
               mode='markers',
               marker=Marker(symbol='dot',
                             size=10,
...
plotly.offline.plot(fig, filename='density_4')
